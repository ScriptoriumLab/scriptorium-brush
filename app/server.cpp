...
STDAPI DllCanUnloadNow() {
	modian::common::core::logger_service::logger()->info("Start unloading...");
...
STDAPI DllUnregisterServer() {
    modian::common::core::logger_service::logger()->info("Unregistering Modian IME dll...");
    ...
    modian::common::core::logger_service::logger()->info("Successfully unregister Modian IME dll");
...
STDAPI DllRegisterServer() {
	...
	modian::common::core::logger_service::logger()->info("Registering Modian IME dll...");
    ...
    if (!modian::brush::infra::tsf::dll::com_registration::register_server()
     ...
     || !modian::brush::infra::tsf::dll::com_registration::register_categories()) {
        ...
        modian::common::core::logger_service::logger()->error("Failed to register Modian IME dll!");
    ...
    modian::common::core::logger_service::logger()->info("Successfully register Modian IME dll");
    return S_OK;
}
